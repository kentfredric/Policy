...
=item * B<C<E<lt>PolicyWordTokenE<gt>>> is a simple word expression intended to give some sort of identification, for example: 
C<SimpleVersions>

=back

The purpose here of the C<E<lt>PolicyIdE<gt>_E<lt>PolicyWordTokenE<gt>> is to enforce a simplified visual and machine sort order
